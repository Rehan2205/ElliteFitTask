...
const TaskDashboard = ({
  ...
  const renderTaskCards = (tasks) => (
    tasks.map(task => (
      <div
        key={task.id}
        className={`bg-green-50 rounded-lg shadow-md overflow-hidden border
      ...
      >
        ...
        {/* Card Footer */}
        <div className="px-4 py-3 bg-gray-300 border-t border-gray-100 flex justify-end space-x-2">
          <button
